...
export const GAMES: GameMeta[] = [
  ...
  { id: 'crossy', name: 'Cruza', blurb: 'Atraviesa la calle', category: 'Arcade', accent: '#38bdf8', emoji: '🐔', direction: 'higher', hint: 'Arriba abre una fila nueva.', guide: 'Toca la pantalla para avanzar un paso. Desliza a los lados para cambiar de carril. Cada paso abre una fila nueva de calle o de pasto. Los carros van más lento y siempre dejan un hueco. No hay meta: sigues hasta que te atropellen.' },
  ...
  { id: 'piano', name: 'Teclas', blurb: 'Las negras suben, tócalas a tiempo', category: 'Ritmo', accent: '#e2e8f0', emoji: '🎹', direction: 'higher', hint: 'Toca la negra antes de que se salga.', guide: 'Las teclas suben solas. Toca la negra que va más arriba, antes de que se salga de la pantalla. Si tocas una blanca, o una negra que todavía no toca, pierdes. Cada tecla que aciertas la hace más rápida, desde la primera, hasta que va muy rápido.' },
