...
export const GAMES: GameMeta[] = [
  ...
  { id: 'piano', name: 'Teclas', blurb: 'Las negras suben, tócalas a tiempo', category: 'Ritmo', accent: '#e2e8f0', emoji: '🎹', direction: 'higher', hint: 'Toca la negra antes de que se salga.', guide: 'Las teclas suben solas. Toca la negra que va más arriba, antes de que se salga de la pantalla. Si tocas una blanca, o una negra que todavía no toca, pierdes. Cada acierto las acelera, y el ritmo sigue subiendo poco a poco.' },
